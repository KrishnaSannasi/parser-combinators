...
pub trait ParserCombinators<Input> {
    ...
    where
        Self: Sized,
        FlatMapErr<Self, F>: Parser<Input>,
    {
        FlatMapErr(self, f)
    }
    ...
    where
        Self: Sized,
        FlatMapBoth<Self, F, G>: Parser<Input>,
    {
    ...
    where
        Self: Sized,
        InspectInput<Self, F>: Parser<Input>,
    {
        InspectInput(self, f)
    }
    ...
    where
        Self: Sized,
        FilterInput<Self, F>: Parser<Input>,
    {
        FilterInput(self, f)
    }
    ...
    where
        Self: Sized,
        ZeroOrMore<Self, F>: Parser<Input>,
    {
        ZeroOrMore(self, f)
    }
